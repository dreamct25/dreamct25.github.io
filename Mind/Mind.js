...
const typeItems = [{
    ...
    expexplainFallLove: '你的內心是溫柔的，面對分手時，你會選擇承擔失敗裡大部分的責任，並且也會有懊悔情緒，自責自己當初應該可以做到更多等。你的同情心、感性，會讓你時常處於懷舊的狀態。你很珍惜自己擁有過的情感關係。然而，你也有可能因此對感情堅持著一種不可能被實踐的標準。想對你說，你其實是一個很願意包容不同可能的人，你總是將前任，以及你對他的情感小心收藏，而你已經做得很好了；當包容著過去，同時間，也別忘了提醒自己騰出空間去接納未來。'
}]
let array = []
let newString = ''
let arrayPos;
