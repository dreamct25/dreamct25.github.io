...
interface Date { getFullDateTime(formatType: string | undefined): string }
Date.prototype.getFullDateTime = function(formatType: string | undefined): string { // 更新方法內容與回傳內容 2021/9/22
