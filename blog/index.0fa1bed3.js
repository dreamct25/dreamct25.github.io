...
`),t(c)),m=a("stS02"),g=a("fWYWz");i(document.querySelector(".app")).render(t(l).createElement(l.StrictMode,null,t(l).createElement(f.default,{store:g.default},t(l).createElement(s.BrowserRouter,{basename:"blog"},t(l).createElement(h,null),t(l).createElement(m.default,null)))));